...
//                "Cannot convert an InputStreamResource to a ResourceRegion");
    ...
    public static String toString(Collection<HttpRange> ranges) {
        Assert.isTrue(!ranges.isEmpty(), "Ranges Collection must not be empty");
    ...
    private static class ByteRange extends HttpRange {
        ...
        @Override
        public int hashCode() {
            return (Objects.hashCode(this.firstPos) * 31 +
                    Objects.hashCode(this.lastPos));
        }
    ...
    private static class SuffixByteRange extends HttpRange {
        ...
        @Override
        public int hashCode() {
            return Objects.hashCode(this.suffixLength);
        }
